...
[//]: # (CI_RUN_UNIX(git clone https://github.com/mgba-emu/mgba.git))
[//]: # (CI_RUN_UNIX(cd mgba))
...
[//]: # (CI_RUN_UBUNTU_PROMPT(sudo apt-get install libz-dev))
[//]: # (CI_RUN_UBUNTU(cmake -DCMAKE_INSTALL_PREFIX:PATH=/usr ..))
...
[//]: # (CI_RUN_MACOS(brew install cmake ffmpeg imagemagick libzip qt5 sdl2 libedit))
[//]: # (CI_RUN_MACOS(cmake -DCMAKE_PREFIX_PATH=`brew --prefix qt5` ..))
[//]: # (CI_RUN_UNIX(make))
[//]: # (CI_RUN_UBUNTU(sudo make install))
