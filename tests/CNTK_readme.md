...
[//]: # (CI_RUN_UBUNTU(sudo mkdir /usr/local/mklml))
[//]: # (CI_RUN_UBUNTU(sudo wget https://github.com/01org/mkl-dnn/releases/download/v0.11/mklml_lnx_2018.0.1.20171007.tgz))
[//]: # (CI_RUN_UBUNTU(sudo tar -xzf mklml_lnx_2018.0.1.20171007.tgz -C /usr/local/mklml))
On Windows:
