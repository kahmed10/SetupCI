...
[//]: # (CI_RUN_UNIX(git clone https://github.com/npm/npm.git))
[//]: # (CI_RUN_UNIX(cd npm))
[//]: # (CI_RUN_UBUNTU_PROMPT(sudo apt-get install make))
[//]: # (CI_RUN_UBUNTU(wget -qO- https://deb.nodesource.com/setup_4.x | sudo bash -))
[//]: # (CI_RUN_UBUNTU_PROMPT(sudo apt-get install nodejs))
[//]: # (CI_RUN_MACOS(brew install nodejs))
[//]: # (CI_RUN_UNIX(sudo make install))
